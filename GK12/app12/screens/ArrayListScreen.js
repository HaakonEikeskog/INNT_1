...
import { PRISKLASSE } from '../data/const';  // Importer PRISKLASSE fra dataen din
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.headerText}>
                Hvilken prisklasse ønsker du å handle?
            </Text>
            <View style={styles.listContainer}>
                <ScrollView>
                    {/* Bruk map til å iterere over PRISKLASSE arrayet */}
                    {PRISKLASSE.map((country, index) => (
                        <TouchableOpacity
                            key={index}
                            style={[
                                styles.item,
